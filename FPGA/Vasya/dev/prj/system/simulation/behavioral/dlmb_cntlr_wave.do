...
#
#  File     dlmb_cntlr_wave.do (Sat Mar 17 02:06:09 2018)
#
...
# eval add wave -noupdate $hexopt $tbpath${ps}dlmb_cntlr${ps}LMB1_ABus
# eval add wave -noupdate $hexopt $tbpath${ps}dlmb_cntlr${ps}LMB1_WriteDBus
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}LMB1_AddrStrobe
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}LMB1_ReadStrobe
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}LMB1_WriteStrobe
# eval add wave -noupdate $hexopt $tbpath${ps}dlmb_cntlr${ps}LMB1_BE
# eval add wave -noupdate $hexopt $tbpath${ps}dlmb_cntlr${ps}Sl1_DBus
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}Sl1_Ready
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}Sl1_Wait
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}Sl1_UE
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}Sl1_CE
# eval add wave -noupdate $hexopt $tbpath${ps}dlmb_cntlr${ps}LMB2_ABus
# eval add wave -noupdate $hexopt $tbpath${ps}dlmb_cntlr${ps}LMB2_WriteDBus
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}LMB2_AddrStrobe
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}LMB2_ReadStrobe
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}LMB2_WriteStrobe
# eval add wave -noupdate $hexopt $tbpath${ps}dlmb_cntlr${ps}LMB2_BE
# eval add wave -noupdate $hexopt $tbpath${ps}dlmb_cntlr${ps}Sl2_DBus
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}Sl2_Ready
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}Sl2_Wait
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}Sl2_UE
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}Sl2_CE
# eval add wave -noupdate $hexopt $tbpath${ps}dlmb_cntlr${ps}LMB3_ABus
# eval add wave -noupdate $hexopt $tbpath${ps}dlmb_cntlr${ps}LMB3_WriteDBus
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}LMB3_AddrStrobe
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}LMB3_ReadStrobe
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}LMB3_WriteStrobe
# eval add wave -noupdate $hexopt $tbpath${ps}dlmb_cntlr${ps}LMB3_BE
# eval add wave -noupdate $hexopt $tbpath${ps}dlmb_cntlr${ps}Sl3_DBus
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}Sl3_Ready
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}Sl3_Wait
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}Sl3_UE
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}Sl3_CE
...
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}UE
# eval add wave -noupdate $binopt $tbpath${ps}dlmb_cntlr${ps}CE
