...
#
#  File     ilmb_cntlr_list.do (Sat Mar 17 02:06:09 2018)
#
...
# eval add list $hexopt $tbpath${ps}ilmb_cntlr${ps}LMB1_ABus
# eval add list $hexopt $tbpath${ps}ilmb_cntlr${ps}LMB1_WriteDBus
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}LMB1_AddrStrobe
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}LMB1_ReadStrobe
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}LMB1_WriteStrobe
# eval add list $hexopt $tbpath${ps}ilmb_cntlr${ps}LMB1_BE
# eval add list $hexopt $tbpath${ps}ilmb_cntlr${ps}Sl1_DBus
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}Sl1_Ready
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}Sl1_Wait
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}Sl1_UE
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}Sl1_CE
# eval add list $hexopt $tbpath${ps}ilmb_cntlr${ps}LMB2_ABus
# eval add list $hexopt $tbpath${ps}ilmb_cntlr${ps}LMB2_WriteDBus
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}LMB2_AddrStrobe
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}LMB2_ReadStrobe
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}LMB2_WriteStrobe
# eval add list $hexopt $tbpath${ps}ilmb_cntlr${ps}LMB2_BE
# eval add list $hexopt $tbpath${ps}ilmb_cntlr${ps}Sl2_DBus
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}Sl2_Ready
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}Sl2_Wait
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}Sl2_UE
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}Sl2_CE
# eval add list $hexopt $tbpath${ps}ilmb_cntlr${ps}LMB3_ABus
# eval add list $hexopt $tbpath${ps}ilmb_cntlr${ps}LMB3_WriteDBus
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}LMB3_AddrStrobe
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}LMB3_ReadStrobe
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}LMB3_WriteStrobe
# eval add list $hexopt $tbpath${ps}ilmb_cntlr${ps}LMB3_BE
# eval add list $hexopt $tbpath${ps}ilmb_cntlr${ps}Sl3_DBus
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}Sl3_Ready
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}Sl3_Wait
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}Sl3_UE
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}Sl3_CE
...
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}UE
# eval add list $binopt $tbpath${ps}ilmb_cntlr${ps}CE
